...
const Home: NextPage = () => {
  ...
  return (
    <>
      ...
      <main className="flex flex-col justify-center h-screen justify-items-stretch">
        <div className=" h-full w-full bg-slate-100 border-x">
        <div className=" flex justify-between w-full gap-4 bg-white border-x p-2 shadow-sm align-middle">
        ...
        <Card w='99%' alignSelf='center' backgroundColor='white'>
          ...
          <div className="flex flex-col align-bottom w-full gap-4">
          <Stack  alignContent='end' justifyContent='end' backgroundColor='white' p={1}>
            <HStack justifyContent='center' p={1}>
              ...
              <PlusSquareIcon color='red' w={6} h={6} fontWeight='thin' />
              </VStack>
            </HStack>
          </Stack>
          </div>
